                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="proforma.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-pen fa-sm text-white-50"></i> Add New Client</a>
...
$sql="SELECT  * from clients WHERE reg_by='".$_SESSION['email']."' order by reg_date desc";            
                ...
                if(mysqli_num_rows($result) > 0){
									...
									echo "<td style='text-transform:uppercase;'>  <a style='color:green;'  href='edit_client.php?client_id=".$row['client_id']."&&invoice_no=".$row['invoice_no']."'>" ." EDIT"."</a>&nbsp;";  echo  "</td>";
									echo "</tr>";
								}
