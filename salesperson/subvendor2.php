                        ...
                        <div class="col-xl-12 col-lg-7">
                            ...
                            <div class="card shadow mb-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="insert_payment2.php">
                                    <fieldset>
...
<td><input id='subvendor_account_name' type='text' name='subvendor_account_name' /></td>
</tr>

<tr>
<td width="20%"><h5>SV Account Number: </h5></td>
<td><input id='subvendor_account_number' type='text' name='subvendor_account_number' /></td>
</tr>

<tr>
<td width="20%"><h5>Bank: </h5></td>
<td><input id='bank' type='text' name='bank' /></td>
</tr>

<tr>
<td width="20%"><h5>Amount Approved: </h5></td>
<td><input id='amount_payable' type='number' class="form-control" name='amount_payable' /></td>
</tr>
