...
$sql="SELECT DISTINCT client_id, invoice_no, invoice_date from invoicing WHERE invoiced_by='".$_SESSION['email']."' order by invoice_date desc";            
                ...
                if(mysqli_num_rows($result) > 0){
                                    ...
                                    //echo "<td>  &nbsp;&nbsp;" .$invoice_sent." times</td>";
								
									echo "<td style='text-transform:uppercase;'>  <a style='color:green;' target='_blank' href='view_invoice.php?client_id=".$row['client_id']."&&invoice_no=".$row['invoice_no']."'>" ." VIEW"."</a>&nbsp;"; echo "|&nbsp;"; echo "<a style='color:green;' target='_blank' href='pdfstore.php?client_id=".$row['client_id']."&&invoice_no=".$row['invoice_no']."&&client_email=".$client_email."'>" ."Email"."</a> <br/>  </td>";
									echo "</tr>";
								}
