...
VALUES ('".$client_id."', '".$commission."', '".$remarks."', '".$phone_no."', '".$client_email."', '".$invoice_no."', '".$reg_by."', '".$amount."' ,  '".$transfer_date."')";
            
if ($link->query($sql2) === TRUE) {


	header('Location: payment_mgt.php?client_id=' .$client_id . '&&msg3='.$msg3.'&&caution='.$caution);
