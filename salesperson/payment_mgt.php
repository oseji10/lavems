...
$sql="SELECT  * from payments WHERE processed_by='".$_SESSION['email']."' order by payment_date desc";            
                ...
                if(mysqli_num_rows($result) > 0){
									...
									echo "<td style='text-transform:uppercase;'> <a style='color:green;' href='edit_payment.php?client_id=".$row['client_id']."&&invoice_no=".$row['invoice_no']."'>" ." EDIT"."</a>&nbsp;"; echo "|&nbsp;"; echo "<a style='color:green;' target='_blank' href='view_receipt.php?client_id=".$row['client_id']."&&invoice_no=".$row['invoice_no']."'>" ." PRINT"."</a>&nbsp;"; echo "|&nbsp;"; echo "<a style='color:green;' target='_blank' href='pdfstore2.php?client_id=".$row['client_id']."&&invoice_no=".$row['invoice_no']."&&client_email=".$client_email."'>" ."Email"."</a> <br/>  </td>";
									echo "</tr>";
								}
