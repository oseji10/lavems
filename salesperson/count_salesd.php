...
$sql1="SELECT  SUM(cost*qty) as total1 from invoicing where invoice_date ='".$today."' AND invoiced_by ='".$_SESSION['email']."'";
...
$sql2="SELECT  SUM(cost*qty) as total2 from invoicing where (invoice_date BETWEEN '".$c."' AND '".$d."') AND invoiced_by ='".$_SESSION['email']."'";
