            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">EDI MANAGEMENT</h1>
...
$sql="select * from edi order by sn desc";            
                ...
                if(mysqli_num_rows($result) > 0){
									...
									echo "<td style='text-transform:uppercase;'>  <a style='color:green;' href='edit_edi.php?sn=".$row['sn']."'>" ." EDIT EDI"."</a>&nbsp;"; echo "|&nbsp;"; echo "<a style='color:red;'  href='delete_edi.php?sn=".$row['sn']."&&invoice_no=".$row['invoice_no']."&&client_email=".$client_email."'>" ."DELETE EDI"."</a> <br/>  </td>";
									echo "</tr>";
								}
