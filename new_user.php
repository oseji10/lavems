...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div class='item'>
      <label for='fname'>USER's FIRSTNAME<span></span></label>
      <input id='fname' type='text' name='fname' />
    </div><br/>
    <br/>

    <div class='item'>
      <label for='lname'>USER's LASTNAME<span></span></label>
      <input id='lname' type='text' name='lname' />
    </div><br/>
    <br/>

    <div class='item'>
      <label for='email'>USER's EMAIL<span></span></label>
      <input id='email' type='text' name='email' />
      <input id='password' type='hidden' name='user_pass' value="<?php echo $show; ?>"/>
    </div><br/>
    <br/>
    ...
    <br/>
                                    ...
                                    <input type='submit' value='Add USER' style=' background-color: #4CAF50; border: none; color: white;
padding: 15px 32px;
text-align: center;
