...
<div><br/><b>Type of business: <?php echo $nature; ?></b><br/><br/></div>
<table width="100%" border="1" style="border-collapse:collapse; text-align: center">
<tr>
<td width="45%" rowspan="3">Invoice to: NIRSAL MFB/<?php echo $fullname; ?><br/><br/>Address: <?php echo $contact_address; ?><br/><br/></td>
<td rowspan="4"></td>
<td width="45%"></td>
</tr>
...
<td>Invoice Date: <?php echo $invoice_date; ?></td>
</tr>

<tr>


<td>Invoice Number: <?php echo $invoice_no; ?></td>
</tr>
