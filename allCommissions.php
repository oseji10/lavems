...
$a=$_POST['a'];		
$b=$_POST['b'];							
$sql="select  * from subvendor where payment_date between '".$a."' AND  '".$b."' order by payment_date desc";            
                ...
                if(mysqli_num_rows($result) > 0){
									...
									while($row = mysqli_fetch_array($result)){
                                      ...
                                      $sql34 = "SELECT SUM(commission) as tt FROM subvendor WHERE payment_date BETWEEN '".$a."' AND '".$b."'";
